...
def auto_fact(module, rank, deepcopy=False, ignore_lower_equal_dim=True, fact_led_unit=False):
    if deepcopy:
    ...
    for key, child in module._modules.items():
        ...
        if type(child) == nn.Linear:
            ...
            module._modules[key] = CED(child.in_channels, child.out_channels, r=rank, kernel_size=child.kernel_size, stride=child.stride, 
